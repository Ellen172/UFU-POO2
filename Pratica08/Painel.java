...
public class Painel extends JPanel
{
    ...
    public void jogar (Painel painel) throws InterruptedException {
        ...
        fase1 = new Fase(1, 3, "fase 1", fase2, fase3);        
        fase2 = new Fase(2, 5, "fase 2", fase1, fase4);
        fase3 = new Fase(4, 10, "fase 3", fase4, fase2);
        fase4 = new Fase(6, 5, "fase 4", fase1, fase5);
        fase5 = new Fase(10, 3, "fase 5", null, null); // fim de jogo
        ...
        */
        ...
        if(inimigos.size() == 0){
            // quando não houver mais inimigos no jogo
        }
