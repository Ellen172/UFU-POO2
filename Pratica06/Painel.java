...
public class Painel extends JPanel
{
    ...
    public void jogar (Painel painel) throws InterruptedException {
        ...
        // criando personagem
        FactoryPersonagem fabrica = new FactoryPersonagem();
        personagem = fabrica.createPersonagem(50, 50);
        ...
        personagem.setAtaque(new PoderFraco(personagem.getAtaque()));
        personagem.setAtaque(new PoderMedio(personagem.getAtaque()));
        personagem.setAtaque(new PoderForte(personagem.getAtaque()));
        System.out.println("Ataque do personagem: " + personagem.getAtaque().getValor());
